    ...
    <div className="min-h-screen bg-[#f4f1eb] text-slate-900">
          ...
          <nav className="hidden md:flex items-center gap-6">
            {[
              ...
              <a
                key={label}
                href={href}
                className="text-[16px] md:text-[16px] font-[Poppins] font-medium hover:opacity-80"
              >
                {label}
              </a>
            ))}
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-24 md:py-32 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-slate-800 max-w-prose font-[Poppins]">
              We support healthcare, education, charities, and corporate teams with
              training and consultancy — including workplace sexual harassment —
              to build knowledge, confidence, and practical tools. Delivery is
      ...
      <section className="border-y border-[#c39b6a]/40 bg-[#f4f1eb]">
        <div className="max-w-6xl mx-auto px-4 py-8 grid md:grid-cols-4 gap-6 text-sm">
          ...
          <TrustItem icon={<Award className="h-5 w-5" />} title="Evidence-informed" desc="Grounded in psychiatry & psychology" />
          <TrustItem icon={<Workflow className="h-5 w-5" />} title="Practical tools" desc="Org development & response toolkits" />
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-4 text-slate-800 max-w-prose font-[Poppins]">
              Because awareness isn’t enough — transformation is. From short, high-impact
              workshops to full cultural change, we help organisations embed trauma-informed
              principles across teams, policies and culture. UK-wide delivery, on-site or online.
            </p>

            <h3 className="mt-6 mb-2 font-semibold font-[Poppins]">What we deliver</h3>
            <ul className="space-y-3 text-slate-800">
              <li className="flex items-start gap-3"><Briefcase className="mt-1 h-5 w-5" /> <span><b>Specialist Training & CPD</b> — interactive, evidence-based programmes tailored to role, sector and goals.</span></li>
              <li className="flex items-start gap-3"><Users className="mt-1 h-5 w-5" /> <span><b>Strategic Consultancy</b> — policy development, risk audits, cultural change and leadership coaching.</span></li>
              <li className="flex items-start gap-3"><BookOpenCheck className="mt-1 h-5 w-5" /> <span><b>Supervision & Reflective Practice</b> — structured support for teams working with survivors.</span></li>
              <li className="flex items-start gap-3"><Lightbulb className="mt-1 h-5 w-5" /> <span><b>Service Design & Policy</b> — survivor-centred pathways, SOPs and safeguarding strategies.</span></li>
              <li className="flex items-start gap-3"><Workflow className="mt-1 h-5 w-5" /> <span><b>Resources & Toolkits</b> — organisational development tools, assessment & response tools, documentation & reporting tools, knowledge reinforcement tools, and communication & language tools.</span></li>
            </ul>
          ...
          {/* Outcomes + Who we partner with */}
          <div className="grid gap-6">
            <Card className="rounded-2xl">
              <CardHeader><CardTitle>Outcomes you can expect</CardTitle></CardHeader>
              <CardContent>
                <ul className="space-y-3 text-slate-800">
                  ...
                  <li className="flex items-start gap-2"><CheckCircle className="mt-1 h-4 w-4" /> Pathways & referral routes understood by all staff</li>
                  <li className="flex items-start gap-2"><CheckCircle className="mt-1 h-4 w-4" /> Sustainable culture shift underpinned by evidence & leadership</li>
                </ul>
              </CardContent>
            </Card>

            <Card className="rounded-2xl">
              <CardHeader><CardTitle>Who we partner with</CardTitle></CardHeader>
              <CardContent className="text-slate-800">
                Corporate organisations, NHS & public sector, education, charities & NGOs,
                safeguarding teams, mental health, social care, police & partner agencies.
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section id="programmes" className="bg-[#f4f1eb] border-y border-[#c39b6a]/40">
        <div className="max-w-6xl mx-auto px-4 py-20">
          ...
          <p className="mt-3 text-slate-800 max-w-prose">
            Our CPD-accredited training goes beyond awareness — it builds confidence, competence
            and culture change. Delivered in-person, online or hybrid.
          </p>
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <ProgrammeCard
              ...
              bullets={[
                ...
                "Leadership accountability & data-driven action",
              ]}
              duration="1 day"
            />
            <ProgrammeCard
              ...
              bullets={[
                "Definitions, forms & prevalence",
                "Impact & trauma responses",
                "Myths, indicators & appropriate responses",
              ]}
              duration="1 day"
            />
          </div>
      ...
      <section id="testimonials" className="max-w-6xl mx-auto px-4 py-20">
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-6">
          <Testimonial quote="One of the most impactful trainings our team has had — practical, compassionate, and immediately applicable." name="Clinical Lead" />
          <Testimonial quote="Clear pathways and scripts transformed the confidence of frontline staff." name="Service Manager" />
          <Testimonial quote="Our managers now feel confident having difficult conversations, and we’ve already seen an increase in safer team dynamics." name="Head of HR" />
        </div>
      </section>
      ...
      <section id="contact" className="bg-[#000000] text-[#f4f1eb]">
        <div className="max-w-6xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-10">
          <div>
            ...
            <div className="mt-6 text-sm text-[#f4f1eb]/80 flex items-center gap-2">
              <Mail className="h-4 w-4" /> hello@svtc.uk
            </div>
          </div>

          <Card className="bg-white text-slate-900 rounded-2xl">
            <CardHeader><CardTitle>Request a proposal</CardTitle></CardHeader>
            <CardContent>
              {/* Netlify Form */}
              <form
                name="contact"
              ...
              {/* Build-time ghost form so Netlify always detects it */}
